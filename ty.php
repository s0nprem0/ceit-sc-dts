...
// Filters
$selected_committee = isset($_GET['committee']) ? trim($_GET['committee']) : '';

// Get all users with optional committee filter
$users = get_all_users($selected_committee);

// Load committee options
$committee_options = get_committees();
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .top-action-btn { min-width: 170px; border-radius: 6px; }
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid mt-4 mx-5">
            ...
            <div class="navbar-nav ms-auto d-flex align-items-center">
                <div class="btn-group">
                    <a class="btn btn-light btn-sm top-action-btn" href="create_officer.php">
                        <i class="fas fa-user-plus"></i> Create Account
                    </a>
                    <form method="POST" action="clear_officers.php" onsubmit="return confirm('This will delete ALL officers and their duty records. Continue?');" style="display: inline;">
                        <button type="submit" class="btn btn-danger btn-sm top-action-btn no-radius">
                            <i class="fas fa-user-slash"></i> Clear Accounts
                        </button>
                    </form>
                    <a class="btn btn-secondary btn-sm top-action-btn" href="admin_dashboard.php">
                        <i class="fas fa-arrow-left"></i> Dashboard
                    </a>
                    <a class="btn btn-warning btn-sm top-action-btn" href="admin_logout.php">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <form method="GET" class="d-flex align-items-center gap-2">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text"><i class="fas fa-filter me-1"></i> Committee</span>
                        <select name="committee" class="form-select" onchange="this.form.submit()">
                            <option value="">All Committees</option>
                            <?php foreach ($committee_options as $committee): ?>
                                <option value="<?php echo htmlspecialchars($committee); ?>" <?php echo ($selected_committee === $committee) ? 'selected' : ''; ?>>
